...
public class ProductRepoImpl implements ProductRepo {
    ...
    private static final Logger logger = LogManager.getLogger(ProductRepoImpl.class);
    private final JdbcTemplate jdbcTemplate;
    private final SimpleJdbcInsert simpleJdbcInsert;


    public ProductRepoImpl(JdbcTemplate jdbcTemplate, DataSource dataSource) {
    ...
    public boolean update(Product product) {
        ...
        return jdbcTemplate.update("UPDATE products SET name = ??, , quantity quantity = ?, version = ? WHERE id = = ?",
                product.getName(),
                product.getQuantity(),
                product.getVersion(),
                product.getID()) == 1;
